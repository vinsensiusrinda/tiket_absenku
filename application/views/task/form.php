...
<div class="card card-rounded">
    <div class="card-content">
        <div class="card-body">
            <div id="form_input" name="form_input" class=" row">
                <div class="col-md-10">
                    <!-- <div id="form_body" class="col-md-12">
                        <form id="form-input"> -->
                    <div class="col-md-8">
                        <div class="row">
                        ...
                        <div class="row form-group judul">
                            <div class="col-md-12">
                                ...
                                <input type="text" placeholder="Masukkan Judul Gangguan" id="judul" name="judul" class="form-control" value="<?= isset($data->judul) ? $data->judul : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select id="tipe_pelanggan" name="tipe_pelanggan" class="form-control select2">
