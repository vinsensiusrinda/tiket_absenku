                ...
                <ul class="mega-dropdown-menu dropdown-menu row">
                    <li class="col-md-12 p-0" data-mega-col="col-md-12">
                        <ul class="drilldown-menu">
                            <li class="menu-list">
                                <ul class="mega-menu-sub">
                                    <li class="<?= ($aktif=='cabang')?'active':''?>">
                                        <a class="dropdown-item" href="<?= site_url('master/cabang') ?>">
                                            Cabang
                                        </a>
                                    </li>
                        ...
                        <ul class="drilldown-menu">
                            <li class="menu-list">
                                <ul class="mega-menu-sub">
                                    ...
                                    <li class="<?= ($aktif=='kepala_cabang')?'active':''?>">
                                        <a class="dropdown-item" href="<?= site_url('pengaturan/kepala-cabang') ?>">
                                            Kepala Cabang
                                        </a>
                                    </li>
                                    ...
                                    <li class="<?= ($aktif=='pengaturan_notif')?'active':''?>">
                                        <a class="dropdown-item" href="<?= site_url('pengaturan/notif') ?>">
                                            Pengaturan Notif
                                        </a>
                                    </li>
